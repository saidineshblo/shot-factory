...
const trainings_1 = require("./resources/trainings.js");
...
const deployments_1 = require("./resources/deployments/deployments.js");
const models_1 = require("./resources/models/models.js");
const webhooks_1 = require("./resources/webhooks/webhooks.js");
const run_1 = require("./lib/run.js");
const wait_1 = require("./lib/wait.js");
/**
...
class Replicate {
     ...
     */
    constructor(opts = {}) {
        _Replicate_encoder.set(this, void 0);
        ...
        this.trainings = new API.Trainings(this);
        this.webhooks = new API.Webhooks(this);
        this.files = new API.Files(this);
        const baseURL = opts.baseURL ?? (0, env_1.readEnv)('REPLICATE_BASE_URL');
        let bearerToken = opts.bearerToken ?? (0, env_1.readEnv)('REPLICATE_API_TOKEN');
        if ('auth' in opts && !('bearerToken' in opts) && opts.auth !== undefined) {
            bearerToken = opts.auth;
        }
        if (bearerToken === undefined) {
            throw new Errors.ReplicateError("The REPLICATE_API_TOKEN environment variable is missing or empty; either provide it, or instantiate the Replicate client with an bearerToken option, like new Replicate({ bearerToken: 'My Bearer Token' }).");
        }
        const options = {
            bearerToken,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('REPLICATE_LOG'), "process.env['REPLICATE_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Replicate_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.ReplicateError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Replicate_encoder, "f").call(this, { body, headers });
        }
    }
    /**
    ...
    async run(ref, options, progress) {
        return (0, run_1.run)(this, this.fetch, ref, options, progress);
    }
    /**
    ...
    async wait(prediction, options, stop) {
        return (0, wait_1.wait)(this, prediction, options, stop);
    }
}
exports.Replicate = Replicate;
_a = Replicate, _Replicate_encoder = new WeakMap();
Replicate.Replicate = _a;
Replicate.DEFAULT_TIMEOUT = 60000; // 1 minute
Replicate.ReplicateError = Errors.ReplicateError;
Replicate.APIError = Errors.APIError;
Replicate.APIConnectionError = Errors.APIConnectionError;
Replicate.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Replicate.APIUserAbortError = Errors.APIUserAbortError;
Replicate.NotFoundError = Errors.NotFoundError;
Replicate.ConflictError = Errors.ConflictError;
Replicate.RateLimitError = Errors.RateLimitError;
Replicate.BadRequestError = Errors.BadRequestError;
Replicate.AuthenticationError = Errors.AuthenticationError;
Replicate.InternalServerError = Errors.InternalServerError;
Replicate.PermissionDeniedError = Errors.PermissionDeniedError;
Replicate.UnprocessableEntityError = Errors.UnprocessableEntityError;
Replicate.toFile = Uploads.toFile;
Replicate.Collections = collections_1.Collections;
Replicate.Deployments = deployments_1.Deployments;
Replicate.Hardware = hardware_1.Hardware;
Replicate.Account = account_1.Account;
Replicate.Models = models_1.Models;
Replicate.Predictions = predictions_1.Predictions;
Replicate.Trainings = trainings_1.Trainings;
Replicate.Webhooks = webhooks_1.Webhooks;
Replicate.Files = files_1.Files;
