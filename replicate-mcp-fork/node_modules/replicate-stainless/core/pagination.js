...
exports.CursorURLPage = exports.CursorURLPageWithCreatedFilters = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.ReplicateError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
class CursorURLPageWithCreatedFilters extends AbstractPage {
    constructor(client, response, body, options) {
...
exports.CursorURLPageWithCreatedFilters = CursorURLPageWithCreatedFilters;
class CursorURLPage extends AbstractPage {
    constructor(client, response, body, options) {
        super(client, response, body, options);
        this.results = body.results || [];
        this.next = body.next || '';
...
exports.CursorURLPage = CursorURLPage;
