...
exports.parseProgressFromLogs = parseProgressFromLogs;
    ...
    return new FileOutput({
        async start(controller) {
            ...
            if (!response.ok) {
                ...
                controller.error(new error_1.APIError(response.status, {}, `Request to ${url} failed with status ${response.status}: ${text}`, response.headers));
            }
