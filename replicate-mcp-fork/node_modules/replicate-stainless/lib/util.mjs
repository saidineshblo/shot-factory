...
export async function transform(value, mapper) {
...
export function createFileOutput({ url, fetch }) {
    ...
    return new FileOutput({
        async start(controller) {
            ...
            if (!response.ok) {
                ...
                controller.error(new APIError(response.status, {}, `Request to ${url} failed with status ${response.status}: ${text}`, response.headers));
            }
 ...
 */
export function parseProgressFromLogs(input) {
