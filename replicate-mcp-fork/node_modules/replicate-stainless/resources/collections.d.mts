...
export declare class Collections extends APIResource {
     ...
     * ```
     */
    get(params: CollectionGetParams, options?: RequestOptions): APIPromise<void>;
}
export interface CollectionGetParams {
    /**
     * The slug of the collection, like `super-resolution` or `image-restoration`. See
     * [replicate.com/collections](https://replicate.com/collections).
     */
    collection_slug: string;
}
export declare namespace Collections {
    export { type CollectionGetParams as CollectionGetParams };
}
