...
export declare class Files extends APIResource {
     ...
     */
    list(options?: RequestOptions): PagePromise<FileListResponsesCursorURLPage, FileListResponse>;
    /**
     * Delete a file. Once a file has been deleted, subsequent requests to the file
     ...
     * ```
     */
    delete(params: FileDeleteParams, options?: RequestOptions): APIPromise<void>;
    /**
     ...
     * ```
     */
    download(params: FileDownloadParams, options?: RequestOptions): APIPromise<Response>;
    /**
     ...
     * ```
     */
    get(params: FileGetParams, options?: RequestOptions): APIPromise<FileGetResponse>;
}
export type FileListResponsesCursorURLPage = CursorURLPage<FileListResponse>;
/**
 * A file resource
 */
export interface FileCreateResponse {
     ...
     */
    checksums: FileCreateResponse.Checksums;
    /**
...
export interface FileListResponse {
     ...
     * A dictionary of checksums for the file keyed by the algorithm name
     */
    checksums: FileListResponse.Checksums;
    /**
     * The content / MIME type of the file
     */
    content_type: string;
...
export interface FileGetResponse {
     ...
     * A dictionary of checksums for the file keyed by the algorithm name
     */
    checksums: FileGetResponse.Checksums;
    /**
     * The content / MIME type of the file
     */
    content_type: string;
...
export interface FileDownloadParams {
    /**
     * Path param: The ID of the file to download
     */
    file_id: string;
    /**
     * Query param: A Unix timestamp with expiration date of this download URL
     */
    expiry: number;
    /**
     * Query param: The username of the user or organization that uploaded the file
     */
    owner: string;
    /**
     * Query param: A base64-encoded HMAC-SHA256 checksum of the string '{owner} {id}
     * {expiry}' generated with the Files API signing secret
     */
    signature: string;
}
...
export declare namespace Files {
    export { type FileCreateResponse as FileCreateResponse, type FileListResponse as FileListResponse, type FileGetResponse as FileGetResponse, type FileListResponsesCursorURLPage as FileListResponsesCursorURLPage, type FileCreateParams as FileCreateParams, type FileDeleteParams as FileDeleteParams, type FileDownloadParams as FileDownloadParams, type FileGetParams as FileGetParams, };
}
