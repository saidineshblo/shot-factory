...
import * as ExamplesAPI from "./examples.mjs";
import { ExampleListParams, Examples } from "./examples.mjs";
import * as PredictionsAPI from "./predictions.mjs";
import { PredictionCreateParams, Predictions } from "./predictions.mjs";
import * as ReadmeAPI from "./readme.mjs";
import { Readme, ReadmeGetParams, ReadmeGetResponse } from "./readme.mjs";
import * as VersionsAPI from "./versions.mjs";
import { VersionDeleteParams, VersionGetParams, VersionListParams, Versions } from "./versions.mjs";
...
export declare class Models extends APIResource {
    examples: ExamplesAPI.Examples;
    predictions: PredictionsAPI.Predictions;
    readme: ReadmeAPI.Readme;
     ...
     * ```
     */
    create(body: ModelCreateParams, options?: RequestOptions): APIPromise<void>;
    /**
     ...
     * ```
     */
    list(options?: RequestOptions): PagePromise<ModelListResponsesCursorURLPage, ModelListResponse>;
    /**
     * Delete a model
     *
     ...
     * @example
     * ```ts
     * await replicate.models.delete({
     *   model_owner: 'model_owner',
     *   model_name: 'model_name',
     * });
     * ```
     */
    delete(params: ModelDeleteParams, options?: RequestOptions): APIPromise<void>;
    /**
     * Example cURL request:
     *
     * ```console
     ...
     * ```
     */
    get(params: ModelGetParams, options?: RequestOptions): APIPromise<void>;
    /**
     ...
     * @example
     * ```ts
     * await replicate.models.search({ body: 'body' });
     * ```
     */
    search(params: ModelSearchParams, options?: RequestOptions): APIPromise<void>;
}
export type ModelListResponsesCursorURLPage = CursorURLPage<ModelListResponse>;
...
export interface ModelCreateParams {
    /**
     * The SKU for the hardware used to run the model. Possible values can be retrieved
     * from the `hardware.list` endpoint.
     */
    hardware: string;
    /**
     * The name of the model. This must be unique among all models owned by the user or
     * organization.
     */
    name: string;
    /**
     * The name of the user or organization that will own the model. This must be the
    ...
    owner: string;
    /**
     * Whether the model should be public or private. A public model can be viewed and
...
export declare namespace Models {
    export { type ModelListResponse as ModelListResponse, type ModelListResponsesCursorURLPage as ModelListResponsesCursorURLPage, type ModelCreateParams as ModelCreateParams, type ModelDeleteParams as ModelDeleteParams, type ModelGetParams as ModelGetParams, type ModelSearchParams as ModelSearchParams, };
    export { Examples as Examples, type ExampleListParams as ExampleListParams };
    export { Predictions as Predictions, type PredictionCreateParams as PredictionCreateParams };
    export { Readme as Readme, type ReadmeGetResponse as ReadmeGetResponse, type ReadmeGetParams as ReadmeGetParams, };
    export { Versions as Versions, type VersionListParams as VersionListParams, type VersionDeleteParams as VersionDeleteParams, type VersionGetParams as VersionGetParams, };
}
