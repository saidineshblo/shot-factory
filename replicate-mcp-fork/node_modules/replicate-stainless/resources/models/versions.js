...
class Versions extends resource_1.APIResource {
    ...
    list(params, options) {
        ...
        return this._client.get((0, path_1.path) `/models/${model_owner}/${model_name}/versions`, {
            ...options,
    ...
    delete(params, options) {
        ...
        return this._client.delete((0, path_1.path) `/models/${model_owner}/${model_name}/versions/${version_id}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
    ...
    get(params, options) {
        const { model_owner, model_name, version_id } = params;
        return this._client.get((0, path_1.path) `/models/${model_owner}/${model_name}/versions/${version_id}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
