...
export declare class Trainings extends APIResource {
    /**
...
export declare namespace TrainingCreateResponse {
    /**
     * Metrics about the training process
     */
    interface Metrics {
...
export declare namespace TrainingListResponse {
    /**
     * Metrics about the training process
     */
    interface Metrics {
...
export declare namespace TrainingCancelResponse {
    /**
     * Metrics about the training process
     */
    interface Metrics {
...
export declare namespace TrainingGetResponse {
    /**
     * Metrics about the training process
     */
    interface Metrics {
...
export declare namespace Trainings {
    export { type TrainingCreateResponse as TrainingCreateResponse, type TrainingListResponse as TrainingListResponse, type TrainingCancelResponse as TrainingCancelResponse, type TrainingGetResponse as TrainingGetResponse, type TrainingListResponsesCursorURLPage as TrainingListResponsesCursorURLPage, type TrainingCreateParams as TrainingCreateParams, type TrainingCancelParams as TrainingCancelParams, type TrainingGetParams as TrainingGetParams, };
}
//# sourceMappingURL=trainings.d.mts.map