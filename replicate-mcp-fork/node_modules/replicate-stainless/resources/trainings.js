...
class Trainings extends resource_1.APIResource {
    /**
    ...
    create(params, options) {
        ...
        return this._client.post((0, path_1.path) `/models/${model_owner}/${model_name}/versions/${version_id}/trainings`, {
            body,
            ...options,
        });
    }
     ...
     */
    list(options) {
        return this._client.getAPIList('/trainings', (pagination_1.CursorURLPage), options);
    }
    /**
     * Cancel a training
     */
    cancel(params, options) {
        ...
        return this._client.post((0, path_1.path) `/trainings/${training_id}/cancel`, options);
    }
    /**
    ...
    get(params, options) {
        const { training_id } = params;
        return this._client.get((0, path_1.path) `/trainings/${training_id}`, options);
    }
}
