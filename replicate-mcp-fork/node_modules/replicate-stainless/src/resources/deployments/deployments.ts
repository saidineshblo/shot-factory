...
import { PredictionCreateParams, Predictions } from './predictions';
...
export class Deployments extends APIResource {
   ...
   * `current_release`.
   */
  update(params: DeploymentUpdateParams, options?: RequestOptions): APIPromise<DeploymentUpdateResponse> {
    const { deployment_owner, deployment_name, ...body } = params;
    return this._client.patch(path`/deployments/${deployment_owner}/${deployment_name}`, {
      body,
      ...options,
    });
  }
   ...
   * ```
   */
  list(options?: RequestOptions): PagePromise<DeploymentListResponsesCursorURLPage, DeploymentListResponse> {
    return this._client.getAPIList('/deployments', CursorURLPage<DeploymentListResponse>, options);
  }
   ...
   */
  delete(params: DeploymentDeleteParams, options?: RequestOptions): APIPromise<void> {
    const { deployment_owner, deployment_name } = params;
    return this._client.delete(path`/deployments/${deployment_owner}/${deployment_name}`, {
      ...options,
   ...
   * ```
   */
  get(params: DeploymentGetParams, options?: RequestOptions): APIPromise<DeploymentGetResponse> {
    const { deployment_owner, deployment_name } = params;
    return this._client.get(path`/deployments/${deployment_owner}/${deployment_name}`, options);
  }
}

export type DeploymentListResponsesCursorURLPage = CursorURLPage<DeploymentListResponse>;

export interface DeploymentCreateResponse {
  current_release?: DeploymentCreateResponse.CurrentRelease;
...
export namespace DeploymentCreateResponse {
  export interface CurrentRelease {
    configuration?: CurrentRelease.Configuration;
    ...
    created_by?: CurrentRelease.CreatedBy;
  ...
  export namespace CurrentRelease {
...
export interface DeploymentUpdateResponse {
  current_release?: DeploymentUpdateResponse.CurrentRelease;
...
export namespace DeploymentUpdateResponse {
  export interface CurrentRelease {
    configuration?: CurrentRelease.Configuration;
...
export interface DeploymentListResponse {
  current_release?: DeploymentListResponse.CurrentRelease;
...
export interface DeploymentGetResponse {
  current_release?: DeploymentGetResponse.CurrentRelease;
...
export interface DeploymentUpdateParams {
  ...
  /**
   * Body param: The SKU for the hardware used to run the model. Possible values can
   * be retrieved from the `hardware.list` endpoint.
   */
  hardware?: string;

  /**
   * Body param: The maximum number of instances for scaling.
   */
  max_instances?: number;

  /**
   * Body param: The minimum number of instances for scaling.
   */
  min_instances?: number;

  /**
   * Body param: The ID of the model version that you want to deploy
   */
  version?: string;
}
...
Deployments.Predictions = Predictions;
