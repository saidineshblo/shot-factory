...
export class Examples extends APIResource {
   ...
   * @example
   * ```ts
   * await replicate.models.examples.list({
   *   model_owner: 'model_owner',
   *   model_name: 'model_name',
   * });
   * ```
   */
  list(params: ExampleListParams, options?: RequestOptions): APIPromise<void> {
    const { model_owner, model_name } = params;
    return this._client.get(path`/models/${model_owner}/${model_name}/examples`, {
      ...options,
...
export declare namespace Examples {
  export { type ExampleListParams as ExampleListParams };
}
