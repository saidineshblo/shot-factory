...
export class Predictions extends APIResource {
   ...
   * ```ts
   * const prediction =
   *   await replicate.models.predictions.create({
   ...
   * ```
   */
  create(params: PredictionCreateParams, options?: RequestOptions): APIPromise<PredictionsAPI.Prediction> {
    const { model_owner, model_name, Prefer, ...body } = params;
    return this._client.post(path`/models/${model_owner}/${model_name}/predictions`, {
      body,
      ...options,
...
export declare namespace Predictions {
  export { type PredictionCreateParams as PredictionCreateParams };
}
