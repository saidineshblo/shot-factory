...
export class Trainings extends APIResource {
  /**
   ...
   */
  create(params: TrainingCreateParams, options?: RequestOptions): APIPromise<TrainingCreateResponse> {
    const { model_owner, model_name, version_id, ...body } = params;
    return this._client.post(path`/models/${model_owner}/${model_name}/versions/${version_id}/trainings`, {
      body,
      ...options,
    });
  }
   ...
   */
  list(options?: RequestOptions): PagePromise<TrainingListResponsesCursorURLPage, TrainingListResponse> {
    return this._client.getAPIList('/trainings', CursorURLPage<TrainingListResponse>, options);
  }

  /**
   * Cancel a training
   */
  cancel(params: TrainingCancelParams, options?: RequestOptions): APIPromise<TrainingCancelResponse> {
    const { training_id } = params;
    return this._client.post(path`/trainings/${training_id}/cancel`, options);
  }
   ...
   */
  get(params: TrainingGetParams, options?: RequestOptions): APIPromise<TrainingGetResponse> {
    const { training_id } = params;
    return this._client.get(path`/trainings/${training_id}`, options);
  }
}

export type TrainingListResponsesCursorURLPage = CursorURLPage<TrainingListResponse>;
...
export interface TrainingCreateResponse {
   ...
   */
  metrics?: TrainingCreateResponse.Metrics;
   ...
   */
  output?: TrainingCreateResponse.Output;
   ...
   */
  urls?: TrainingCreateResponse.URLs;
...
export interface TrainingListResponse {
   ...
   * Metrics about the training process
   */
  metrics?: TrainingListResponse.Metrics;
   ...
   * The output of the training process
   */
  output?: TrainingListResponse.Output;
   ...
   * URLs for interacting with the training
   */
  urls?: TrainingListResponse.URLs;
...
export namespace TrainingListResponse {
  /**
   * Metrics about the training process
   */
  export interface Metrics {
...
export interface TrainingCancelResponse {
  /**
   * The unique ID of the training
   */
  id?: string;
   ...
   * Metrics about the training process
   */
  metrics?: TrainingCancelResponse.Metrics;
   ...
   * The output of the training process
   */
  output?: TrainingCancelResponse.Output;
   ...
   * URLs for interacting with the training
   */
  urls?: TrainingCancelResponse.URLs;
...
export namespace TrainingCancelResponse {
  /**
   * Metrics about the training process
   */
  export interface Metrics {
...
export interface TrainingGetResponse {
  /**
   * The unique ID of the training
   */
  id?: string;
   ...
   * Metrics about the training process
   */
  metrics?: TrainingGetResponse.Metrics;
   ...
   * The output of the training process
   */
  output?: TrainingGetResponse.Output;
...
export namespace TrainingGetResponse {
  /**
   * Metrics about the training process
   */
  export interface Metrics {
...
export interface TrainingCreateParams {
  ...
  /**
   * Body param: A string representing the desired model to push to in the format
  ...
  /**
   * Body param: An HTTPS URL for receiving a webhook when the training completes.
   ...
   * are new outputs or the training has finished. You can change which events
   * trigger webhook requests by specifying `webhook_events_filter` in the training
   * request:
   *
...
export interface TrainingCancelParams {
  /**
...
export interface TrainingGetParams {
  /**
...
export declare namespace Trainings {
  export {
