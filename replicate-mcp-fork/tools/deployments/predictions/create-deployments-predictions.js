...
exports.metadata = {
    ...
    tags: [],
    httpMethod: 'post',
    httpPath: '/deployments/{deployment_owner}/{deployment_name}/predictions',
    operationId: 'deployments.predictions.create',
};
exports.tool = {
    name: 'create_deployments_predictions',
...
const handler = async (replicate, args) => {
    ...
    return (0, types_1.asTextContentResult)(await replicate.deployments.predictions.create(body));
};
exports.handler = handler;
exports.default = { metadata: exports.metadata, tool: exports.tool, handler: exports.handler };
//# sourceMappingURL=create-deployments-predictions.js.map