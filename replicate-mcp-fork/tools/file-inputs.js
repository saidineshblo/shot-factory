...
exports.processFileInputs = void 0;
const fs = require("fs");
...
function isLocalFilePath(str) {
    // Absolute path on Windows (C:\... or C:/...) or Unix (/...)
...
async function uploadLocalFile(replicate, filePath) {
 ...
 */
async function processFileInputs(replicate, input) {
...
exports.processFileInputs = processFileInputs;
